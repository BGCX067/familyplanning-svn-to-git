	...
	<div class="container"> 
		...
		<div class="holder"> 
			...
			<div class="box big"> 
				...
				<div class="content"> 
					<div id="caption">Statics for April</div> 
					<table class="statics"> 
						<thead> 
							<tr> 
								<th></th> 
		...
		<div class="footer"> 
			<div class="split">&#169; Copyright <a href="#">icddrb</a></div> 
			<div class="split right">Powered by <a href="#">icddrb</a></div> 
		</div> 
